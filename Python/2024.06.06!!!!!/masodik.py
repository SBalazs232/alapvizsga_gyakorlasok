...
honap=number_input('Kérem az első dátum honapjat:',12)
nap=number_input('Kérem az első dátum napját:',31)

ev2=number_input('Kérem a második dátum évét:',2024)
honap2=number_input('Kérem a második dátum honapjat:',12)
nap2=number_input('Kérem a második dátum napját:',31)
